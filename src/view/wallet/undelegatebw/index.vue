<template>
  <el-card>
    ...
    <el-form :model="form" :rules="rules" ref="form">
      ...
      <el-form-item label="取消委托net数量 -- 例: 100.00 EOS" prop="unstake_net_quantity">
        <el-input v-model="form.unstake_net_quantity" placeholder="EOS网络的NET"></el-input>
      </el-form-item>
      <el-form-item label="取消委托cpu数量 -- 例: 100.00 EOS" prop="unstake_cpu_quantity">
        <el-input v-model="form.unstake_cpu_quantity" placeholder="EOS网络的CPU"></el-input>
      </el-form-item>
      <el-form-item>
        <el-button type="primary" @click="handleSubmit('form')">确定取消委托</el-button>
      </el-form-item>
    </el-form>
    <hr>
  ...
  data () {
    ...
    return {
      ...
      rules: {
        ...
        unstake_net_quantity: {required: true, message: '请输入委托数量，例:100 EOS', trigger: 'blur'},
        unstake_cpu_quantity: {required: true, message: '请输入委托数量，例:100 EOS', trigger: 'blur'}
      },
      // eosmonitor url
